#calamares PKGBUILD for March Linux
...
prepare() {
    ...
    sed -i -e 's#Name=.*#Name=Install March Linux#g' "$srcdir/${pkgname}-${pkgver}/calamares.desktop"
    sed -i -e 's#GenericName=.*#GenericName=March Linux Installer#g' "$srcdir/${pkgname}-${pkgver}/calamares.desktop"
    sed -i -e 's#Icon=.*#Icon=archlinux-logo#g' "$srcdir/${pkgname}-${pkgver}/calamares.desktop"
    sed -i -e 's#Comment=.*#Comment=March Linux Installer#g' "$srcdir/${pkgname}-${pkgver}/calamares.desktop"
